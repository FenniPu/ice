...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Deviant server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Deviant features */
        {"deviant", "masternode", &masternode, true, true, false},
        {"deviant", "listmasternodes", &listmasternodes, true, true, false},
        {"deviant", "getmasternodecount", &getmasternodecount, true, true, false},
        {"deviant", "masternodeconnect", &masternodeconnect, true, true, false},
        {"deviant", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"deviant", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"deviant", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"deviant", "masternodecurrent", &masternodecurrent, true, true, false},
        {"deviant", "masternodedebug", &masternodedebug, true, true, false},
        {"deviant", "startmasternode", &startmasternode, true, true, false},
        {"deviant", "createmasternodekey", &createmasternodekey, true, true, false},
        {"deviant", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"deviant", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"deviant", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"deviant", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"deviant", "getmasternodescores", &getmasternodescores, true, true, false},
        {"deviant", "mnbudget", &mnbudget, true, true, false},
        {"deviant", "preparebudget", &preparebudget, true, true, false},
        {"deviant", "submitbudget", &submitbudget, true, true, false},
        {"deviant", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"deviant", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"deviant", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"deviant", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"deviant", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"deviant", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"deviant", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"deviant", "checkbudgets", &checkbudgets, true, true, false},
        {"deviant", "mnsync", &mnsync, true, true, false},
        {"deviant", "spork", &spork, true, true, false},
        {"deviant", "getpoolinfo", &getpoolinfo, true, true, false},
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:33647/\n";
}
